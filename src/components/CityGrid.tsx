...
const CityGrid: React.FC<CityGridProps> = ({ workers, jobs, onTileClick }) => {
  ...
  const getTileStyle = (hasWorker: boolean, hasJob: boolean) => {
    let baseStyle =
      "w-12 h-12 border border-gray-300 cursor-pointer flex flex-col items-center justify-center text-lg relative transition-all hover:border-black hover:scale-105";
