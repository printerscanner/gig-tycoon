...
// Job icons (removed unused function)
...
export function CityMap({ onTileClick }: CityMapProps) {
  ...
  const center: [number, number] = [52.485, 13.42]; // Kreuzberg center
      ...
      >
            ...
            >
              <Popup>
                <div className="text-sm">
                  ...
                  <div>
                    Status: {worker.isWorking ? "Working" : "Available"}
                  </div>
        ...
        {jobs
          ...
          .map((job) => {
            ...
            const dropoffPosition = gridToLatLng(
              job.dropoff.row,
              job.dropoff.col
            );
